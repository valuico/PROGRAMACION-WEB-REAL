...
const ProductGrid = ({ category }) => {
  ...
  const skincareProducts = [
    ...
    { id: 13, name: 'Gentle Cleanser', description: 'Té Verde + Ceramidas', image: '/cleanser.png', price: 38500, badge: 'Nuevo' },
    { id: 14, name: 'Daily Moisturizer', description: 'Péptidos + Squalane', image: '/crema-hidratante.png', price: 44900, badge: 'Nuevo' },
